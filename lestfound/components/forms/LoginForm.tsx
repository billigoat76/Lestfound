        ...
        <div className="flex flex-col gap-6">
            <Card >
                <CardHeader className="text-center">
                    ...
                    <CardDescription>Login in with Google or Github Account</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="flex flex-col gap-4">
                        ...
                        <form>
                            <Button className="w-full" variant="outline">
                                <Google className="size-8"></Google>
                                Login with Google
                                </Button>
                        </form>
                    </div>
            ...
            <div className="text-center text-s text-muted-foreground text-balance">
                By clicking on the login button, you agree to our <a href="#" className="text-primary">Terms of Service</a> and <a href="#" className="text-primary">Privacy Policy</a>
            </div>
        </div>
    )
}